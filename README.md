...
- **Логотип Claude** стоит неподвижно в простое и вращается, пока Claude Code
  работает. Кадры — `main/icons/logo.bin`, их генерирует
  `tools/export_icons.py`; чтобы заменить анимацию, достаточно поменять кадры.
